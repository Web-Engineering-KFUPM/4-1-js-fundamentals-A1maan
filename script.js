...
const SCHOOL = "MyCollege";
// SCHOOL = "OtherCollege";
// The above reassignment fails because constants cannot be reassigned after their initial declaration.
...
// write code here
console.log("2" + 3); // "23" - These two concatenate because one of the operands is a string, so JS automatically converts the other operand into a string and performs string concatenation.
console.log(2 + "3"); // "23" - Same reason as above.
console.log(2 + 3);
